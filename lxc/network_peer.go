...
func (c *cmdNetworkPeerGet) command() *cobra.Command {
	...
	cmd.Short = "Get values for network peer configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
	cmd.RunE = c.run
...
func (c *cmdNetworkPeerSet) command() *cobra.Command {
	...
	cmd.Long = cli.FormatSection("Description", `Set network peer keys
...
func (c *cmdNetworkPeerUnset) command() *cobra.Command {
	...
	cmd.Short = "Unset network peer configuration keys"
	cmd.Long = cli.FormatSection("Description", "Unset network peer keys")
	cmd.RunE = c.run
...
func (c *cmdNetworkPeerDelete) command() *cobra.Command {
	...
	cmd.Short = "Delete network peerings"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
	cmd.RunE = c.run
