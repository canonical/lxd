	...
	if resource.name != "" {
		...
		if !termios.IsTerminal(getStdinFd()) {
			...
			if isSnapshot {
				...
				check := *snapshotInstance
				check.SetWritable(newdata)
...
// mapsEqual checks two maps whether equal or not.
...
// devicesEqual checks two devices whether equal or not.
...
// sliceEqual checks two slices whether equal or not.
