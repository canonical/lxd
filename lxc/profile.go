...
func (c *cmdProfileAdd) command() *cobra.Command {
	...
	cmd.Short = "Add profiles to instances"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdProfileAssign) command() *cobra.Command {
	...
	cmd.Short = "Assign sets of profiles to instances"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdProfileGet) command() *cobra.Command {
	...
	cmd.Short = "Get values for profile configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdProfileList) command() *cobra.Command {
	...
	cmd.Long = cli.FormatSection("Description", `List profiles
...
func (c *cmdProfileRemove) command() *cobra.Command {
	...
	cmd.Short = "Remove profiles from instances"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdProfileSet) command() *cobra.Command {
	...
	cmd.Long = cli.FormatSection("Description", `Set profile configuration keys
...
func (c *cmdProfileUnset) command() *cobra.Command {
	...
	cmd.Short = "Unset profile configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
