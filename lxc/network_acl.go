...
func (c *cmdNetworkACLList) command() *cobra.Command {
	...
	cmd.Short = "List available network ACLS"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdNetworkACLGet) command() *cobra.Command {
	...
	cmd.Short = "Get values for network ACL configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdNetworkACLCreate) command() *cobra.Command {
	...
	cmd.Short = "Create new network ACLs"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdNetworkACLSet) command() *cobra.Command {
	...
	cmd.Long = cli.FormatSection("Description",`Set network ACL configuration keys
...
func (c *cmdNetworkACLUnset) command() *cobra.Command {
	...
	cmd.Short = "Unset network ACL configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
	cmd.RunE = c.run
...
func (c *cmdNetworkACLDelete) command() *cobra.Command {
	...
	cmd.Short = "Delete network ACLs"
	cmd.Long = cli.FormatSection("Description", "Delete network ACLs")
	cmd.RunE = c.run
...
func (c *cmdNetworkACLRule) commandRemove() *cobra.Command {
	...
	cmd.Short = "Remove rules from an ACL"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
