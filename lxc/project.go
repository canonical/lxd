...
func (c *cmdProjectDelete) command() *cobra.Command {
	...
	cmd.Short = "Delete projects"
	cmd.Long = cli.FormatSection("Description", cmd.Short)

	cmd.Flags().BoolVarP(&c.flagForce, "force", "f", false, cli.FormatStringFlagLabel("Force delete project and its entities"))
...
func (c *cmdProjectGet) command() *cobra.Command {
	...
	cmd.Short = "Get values for project configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdProjectSet) command() *cobra.Command {
	...
	cmd.Long = cli.FormatSection("Description", `Set project configuration keys
...
func (c *cmdProjectUnset) command() *cobra.Command {
	...
	cmd.Short = "Unset project configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
