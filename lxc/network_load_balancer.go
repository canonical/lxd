...
func (c *cmdNetworkLoadBalancerCreate) command() *cobra.Command {
	...
	cmd.Short = "Create new network load balancers"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
...
func (c *cmdNetworkLoadBalancerGet) command() *cobra.Command {
	...
	cmd.Short = "Get values for network load balancer configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
	cmd.RunE = c.run
...
func (c *cmdNetworkLoadBalancerSet) command() *cobra.Command {
	...
	cmd.Long = cli.FormatSection("Description", `Set network load balancer keys
...
func (c *cmdNetworkLoadBalancerUnset) command() *cobra.Command {
	...
	cmd.Short = "Unset network load balancer configuration keys"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
	cmd.RunE = c.run
...
func (c *cmdNetworkLoadBalancerDelete) command() *cobra.Command {
	...
	cmd.Short = "Delete network load balancers"
	cmd.Long = cli.FormatSection("Description", cmd.Short)
	cmd.RunE = c.run
