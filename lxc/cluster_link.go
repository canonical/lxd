...
func (c *cmdClusterLinkCreate) command() *cobra.Command {
	cmd := &cobra.Command{}
	cmd.Use = usage("create", i18n.G("[<remote>:]<link> [--token <trust_token>] [--auth-group <group1,group2,...>] [--description <description>]"))
...
func (c *cmdClusterLinkEdit) command() *cobra.Command {
	cmd := &cobra.Command{}
	cmd.Use = usage("edit", i18n.G("[<remote>:]<link>"))
...
func (c *cmdClusterLinkShow) command() *cobra.Command {
	cmd := &cobra.Command{}
	cmd.Use = usage("show", i18n.G("[<remote>:]<link>"))
...
func (c *cmdClusterLinkInfo) command() *cobra.Command {
	cmd := &cobra.Command{}
	cmd.Use = usage("info", i18n.G("[<remote>:]<link>"))
...
func (c *cmdClusterLinkInfo) run(cmd *cobra.Command, args []string) error {
	...
	for _, member := range clusterLinkState.ClusterLinkMembers {
		line := []string{member.Address, member.ServerName, member.AuthStatus}
