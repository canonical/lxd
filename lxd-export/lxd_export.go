...
func lxdClients() (sourceClient lxd.InstanceServer, targetClient lxd.InstanceServer, err error) {
	...
	sourceClient, err = lxd.ConnectLXD("https://10.237.134.244:8443", &lxd.ConnectionArgs{
	...
	// targetClient, err = lxd.ConnectLXD("https://127.0.0.1:8444", &lxd.ConnectionArgs{
	// 	TLSClientCert:      string(certPEMBlock),
	// 	TLSClientKey:       string(keyPEMBlock),
	// 	InsecureSkipVerify: true,
	// 	SkipGetServer:      true,
