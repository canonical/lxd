...
// Create a new backup.
func backupCreate(s *state.State, args db.InstanceBackup, sourceInst instance.Instance, version api.BackupMetadataVersion, op *operations.Operation) error {
...
func backupWriteIndex(sourceInst instance.Instance, pool storagePools.Pool, optimized bool, snapshots bool, version api.BackupMetadataVersion, tarWriter *instancewriter.InstanceTarWriter) error {
