...
func addImageDetailsToRequestContext(d *Daemon, r *http.Request) error {
...
func imageAccessHandler(entitlement auth.Entitlement) func(d *Daemon, r *http.Request) response.Response {
	return func(d *Daemon, r *http.Request) response.Response {
		err := addImageDetailsToRequestContext(d, r)
		if err != nil {
		...
		err = d.State().Authorizer.CheckPermission(r.Context(), entity.ImageURL(request.ProjectParam(r), details.image.Fingerprint), entitlement)
		if err != nil {
			return response.SmartError(err)
		}
