...
func (c *ClusterTx) GetProfileInstances() (map[int][]int, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "Failed to fetch instance_profiles")
	}
...
func (c *ClusterTx) CreateInstanceProfile(object InstanceProfile) (int64, error) {
	...
	if err != nil {
		return -1, errors.Wrap(err, "Failed to create instance_profile")
	}

	id, err := result.LastInsertId()
	if err != nil {
		return -1, errors.Wrap(err, "Failed to fetch instance_profile ID")
	}
...
func (c *ClusterTx) DeleteInstanceProfiles(object Instance) error {
	...
	if err != nil {
		return errors.Wrap(err, "Delete instance_profile")
	}
