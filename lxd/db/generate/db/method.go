...
// Creates a new entity in the database based on the provided parameters or replaces an existing one if specified.
...
// Creates reference entities or maps for the associated entity in the database based on the provided parameters.
...
// Renames the entity in the database using the provided parameters.
...
// Updates the entity in the database based on the provided parameters, including handling of references and associations.
...
// Updates the references of the entity in the database based on the provided parameters.
...
// Deletes the entity or its references from the database based on the provided parameters.
