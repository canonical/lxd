...
SELECT operations.id, operations.reference, operations.project_id, operations.node_id, operations.type
  FROM operations
...
func getOperations(ctx context.Context, stmt *sql.Stmt, args ...any) ([]Operation, error) {
	...
	dest := func(scan func(dest ...any) error) error {
		o := Operation{}
		err := scan(&o.ID, &o.Reference, &o.ProjectID, &o.NodeID, &o.Type)
		if err != nil {
			return err
		}
