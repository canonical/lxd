...
func getOperations(ctx context.Context, stmt *sql.Stmt, args ...any) ([]Operation, error) {
	...
	dest := func(scan func(dest ...any) error) error {
		o := Operation{}
		err := scan(&o.ID, &o.Reference, &o.NodeAddress, &o.ProjectID, &o.NodeID, &o.Type, &o.RequestorProtocol, &o.RequestorIdentityID, &o.EntityID, &o.Class, &o.CreatedAt, &o.UpdatedAt, &o.Inputs, &o.Status, &o.Error, &o.Stage)
		if err != nil {
			return err
		}
