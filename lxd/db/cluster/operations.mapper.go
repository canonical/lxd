...
func getOperations(ctx context.Context, stmt *sql.Stmt, args ...any) ([]Operation, error) {
	...
	dest := func(scan func(dest ...any) error) error {
		o := Operation{}
		err := scan(&o.ID, &o.UUID, &o.NodeAddress, &o.Location, &o.ProjectID, &o.NodeID, &o.Type, &o.RequestorProtocol, &o.RequestorIdentityID, &o.EntityID, &o.Metadata, &o.Class, &o.CreatedAt, &o.UpdatedAt, &o.Inputs, &o.Status, &o.ConflictReference, &o.Error, &o.Parent, &o.Stage)
		if err != nil {
			return err
		}
	...
	for i, filter := range filters {
		if filter.NodeID != nil && filter.Class != nil && filter.ID == nil && filter.UUID == nil && filter.Parent == nil {
			...
			if len(filters) == 1 {
				...
				if err != nil {
					return nil, fmt.Errorf("Failed to get \"operationObjectsByParent\" prepared statement: %w", err)
				}
