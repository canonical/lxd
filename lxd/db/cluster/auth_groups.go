...
func (g *AuthGroup) ToAPI(ctx context.Context, tx *sql.Tx, canViewIdentity authEntity.PermissionChecker, canViewIDPGroup authEntity.PermissionChecker) (*api.AuthGroup, error) {
	group := &api.AuthGroup{
		Name:        g.Name,
