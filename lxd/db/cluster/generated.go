...
// PKColumns returns the column names for the primary key of a [ImageRegistryRow] entity used during an update.
// The returned slice must have the same number of elements as PKValues.
func (i ImageRegistryRow) PKColumns() []string {
	return []string{"id"}
}

// PKValues returns the values for the primary key of a [ImageRegistryRow] entity used during an update.
// The returned slice must have the same number of elements as PKColumns.
func (i ImageRegistryRow) PKValues() []any {
	return []any{i.ID}
}
