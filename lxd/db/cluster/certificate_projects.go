...
//
//go:generate mapper method -e certificate_project GetMany struct=Certificate version=2
//go:generate mapper method -e certificate_project DeleteMany struct=Certificate version=2
//go:generate mapper method -e certificate_project Create struct=Certificate version=2
//go:generate mapper method -e certificate_project Update struct=Certificate version=2
