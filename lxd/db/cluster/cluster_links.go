...
//
//go:generate mapper method -i -e cluster_link GetMany references=Config
...
//go:generate mapper method -i -e cluster_link Create references=Config
//go:generate mapper method -i -e cluster_link DeleteOne-by-Name
//go:generate mapper method -i -e cluster_link Update references=Config
