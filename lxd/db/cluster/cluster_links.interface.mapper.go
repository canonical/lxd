...
type ClusterLinkGenerated interface {
	// GetClusterLinkConfig returns all available ClusterLink Config
	// generator: cluster_link GetMany
	GetClusterLinkConfig(ctx context.Context, tx *sql.Tx, clusterLinkID int, filters ...ConfigFilter) (map[string]string, error)
	...
	// CreateClusterLinkConfig adds new cluster_link Config to the database.
	// generator: cluster_link Create
	CreateClusterLinkConfig(ctx context.Context, tx *sql.Tx, clusterLinkID int64, config map[string]string) error
	...
	// UpdateClusterLinkConfig updates the cluster_link Config matching the given key parameters.
	// generator: cluster_link Update
	UpdateClusterLinkConfig(ctx context.Context, tx *sql.Tx, clusterLinkID int64, config map[string]string) error
