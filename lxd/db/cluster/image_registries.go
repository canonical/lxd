...
const (
	imageRegistryProtocolCodeSimpleStreams int64 = iota // Image registry protocol "SimpleStreams".
	imageRegistryProtocolCodeLXD                        // Image registry protocol "LXD".
)
...
func (p *ImageRegistryProtocol) ScanInteger(protocolCode int64) error {
	switch protocolCode {
	case imageRegistryProtocolCodeSimpleStreams:
		*p = api.ImageRegistryProtocolSimpleStreams
	case imageRegistryProtocolCodeLXD:
...
func (p ImageRegistryProtocol) Value() (driver.Value, error) {
	...
	case api.ImageRegistryProtocolSimpleStreams:
		return imageRegistryProtocolCodeSimpleStreams, nil
	case api.ImageRegistryProtocolLXD:
		return imageRegistryProtocolCodeLXD, nil
	}
...
func DeleteImageRegistry(ctx context.Context, tx *sql.Tx, name string) error {
	return query.DeleteOne[ImageRegistriesRow](ctx, tx, "WHERE name = ?", name)
}
