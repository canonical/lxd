...
// The zero-value of EntityType (with nil 'entityType') behaves as a "none" entity type, which is used by the warnings system.
...
// underlying entityType is nil, we implement the method for 'entityTypeCodeNone'.
...
// is nil, we implement the method for 'entityTypeCodeNone'.
...
// entityType is nil, we implement the method for 'entityTypeCodeNone'.
...
// If the underlying entityType is nil, we implement the method for 'entityTypeCodeNone'.
...
// IsNone returns true if there is no underlying entityType (e.g. the code was entityTypeCodeNone).
func (e EntityType) IsNone() bool {
...
func (e *EntityType) Scan(value any) error {
	...
	// If the code is entityTypeCodeNone we just set the underlying entityType to nil
