...
func (c *ClusterTx) GetProjectURIs(filter ProjectFilter) ([]string, error) {
	...
	args := []interface{}{}
	stmtStr := cluster.GetRegisteredStmt(projectNames)
...
func (c *ClusterTx) GetProjects(filter ProjectFilter) ([]Project, error) {
	...
	args := []interface{}{}
	stmtStr := cluster.GetRegisteredStmt(projectObjects)
	if filter.Description != "" {
		args = append(args, filter.Description)
		stmtParts := strings.Split(stmtStr, "ORDER BY")
		stmtBody := stmtParts[0]
	...
	// Fill field UsedBy.
	usedByObjects, err := c.ProjectUsedByRef()
	if err != nil {
	...
	// Fill field Config.
	configObjects, err := c.ProjectConfigRef()
	if err != nil {
...
// GetProjectsByName returns all available projects.
// generator: project List-by-Name
func (c *ClusterTx) GetProjectsByName(name string, filter ProjectFilter) ([]Project, error) {
	// Result slice.
	objects := make([]Project, 0)
	...
	stmtStr := cluster.GetRegisteredStmt(projectObjectsByName)
	if filter.Description != "" {
		args = append(args, filter.Description)
		stmtParts := strings.Split(stmtStr, "ORDER BY")
		stmtBody := stmtParts[0]
	...
	// Fill field UsedBy.
	usedByObjects, err := c.ProjectUsedByRefByName(name)
	if err != nil {
		return nil, errors.Wrap(err, "Failed to fetch field UsedBy")
	}
	...
	// Fill field Config.
	configObjects, err := c.ProjectConfigRefByName(name)
	if err != nil {
		return nil, errors.Wrap(err, "Failed to fetch field Config")
	}
...
// GetProjectByName returns the project with the given key.
// generator: project Get-by-Name
func (c *ClusterTx) GetProjectByName(name string, filter ProjectFilter) (*Project, error) {
	objects, err := c.GetProjectsByName(name, filter)
	if err != nil {
...
func (c *ClusterTx) ProjectConfigRef() (map[string]map[string]string, error) {
	// Result slice.
	objects := make([]struct {
		Name  string
		Key   string
...
func (c *ClusterTx) ProjectUsedByRef() (map[string][]string, error) {
	// Result slice.
	objects := make([]struct {
		Name  string
		Value string
...
// ProjectConfigRefByName returns entities used by projects.
// generator: project ConfigRef-by-Name
func (c *ClusterTx) ProjectConfigRefByName(name string) (map[string]map[string]string, error) {
	// Result slice.
	objects := make([]struct {
		Name  string
		Key   string
...
// ProjectUsedByRefByName returns entities used by projects.
// generator: project UsedByRef-by-Name
func (c *ClusterTx) ProjectUsedByRefByName(name string) (map[string][]string, error) {
	// Result slice.
	objects := make([]struct {
		Name  string
		Value string
...
// DeleteProjectByName deletes the project matching the given key parameters.
// generator: project DeleteOne-by-Name
func (c *ClusterTx) DeleteProjectByName(name string, filter ProjectFilter) error {
	stmt := c.stmt(projectDeleteByName)
	args := []interface{}{
		name,
	}
	stmtStr := cluster.GetRegisteredStmt(projectDeleteByName)
	if filter.Description != "" {
		args = append(args, filter.Description)
		stmtParts := strings.Split(stmtStr, "ORDER BY")
		stmtBody := stmtParts[0]
