...
func Test_networkServerErrorLogWriter_shouldDiscard(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			log:     []byte("http: TLS handshake error from 10.24.0.32:55672: write tcp 10.24.0.22:8443->10.24.0.32:55672: write: connection reset by peer\n"),
			want:    "",
		},
		{
		...
		},
		{
			...
			log:     []byte("http: TLS handshake error from [2602:fd23:8:1003:216:3eff:fefa:7670]:55672: write tcp [2602:fd23:8:101::100]:8443->[2602:fd23:8:1003:216:3eff:fefa:7670]:55672: write: connection reset by peer\n"),
			want:    "",
		},
		{
		...
		},
		{
			...
			proxies: []net.IP{net.ParseIP("10.24.0.32")},
			log:     []byte("http: TLS handshake error from 10.24.0.32:55672: read tcp 10.24.0.22:8443->10.24.0.32:55672: read: connection reset by peer\n"),
			want:    "",
		},
		{
		...
		},
		{
			...
			proxies: []net.IP{net.ParseIP("2602:fd23:8:1003:216:3eff:fefa:7670")},
			log:     []byte("http: TLS handshake error from [2602:fd23:8:1003:216:3eff:fefa:7670]:55672: read tcp [2602:fd23:8:101::100]:8443->[2602:fd23:8:1003:216:3eff:fefa:7670]:55672: read: connection reset by peer\n"),
			want:    "",
		},
		{
