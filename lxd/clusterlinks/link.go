...
func GetClusterLinkCertificate(ctx context.Context, joinToken *api.CertificateAddToken, overrideAddresses []string, userAgent string) (*x509.Certificate, string, error) {
	type result struct {
