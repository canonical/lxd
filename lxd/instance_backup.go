...
func instanceBackupsPost(d *Daemon, r *http.Request) response.Response {
	...
	// sending this field.
	if req.Version == 0 {
		req.Version = config.FileMetadataVersion
	} else if !shared.ValueInSlice(req.Version, []api.BackupMetadataVersion{api.BackupMetadataVersion1, api.BackupMetadataVersion2}) {
