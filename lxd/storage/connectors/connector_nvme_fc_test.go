...
func Test_nvmeFCMissingPaths(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			session:    &session{hostAddressesByTarget: map[string][]string{}},
			targetAddr: targetA,
			hostAddrs:  []string{hbaA, hbaB},
			want:       []string{hbaA, hbaB},
		},
		{
			...
			session:    &session{hostAddressesByTarget: map[string][]string{targetA: {hbaA}}},
			targetAddr: targetA,
			hostAddrs:  []string{hbaA, hbaB},
			want:       []string{hbaB},
		},
		{
			...
			session:    &session{hostAddressesByTarget: map[string][]string{targetA: {hbaA, hbaB}}},
			targetAddr: targetA,
			hostAddrs:  []string{hbaA, hbaB},
			want:       []string{},
		},
		{
			...
			session:    &session{hostAddressesByTarget: map[string][]string{targetB: {hbaA, hbaB}}},
			targetAddr: targetA,
			hostAddrs:  []string{hbaA, hbaB},
			want:       []string{hbaA, hbaB},
		},
		{
			...
			session:    &session{hostAddressesByTarget: map[string][]string{strings.ToUpper(targetA): {hbaA}}},
			targetAddr: targetA,
			hostAddrs:  []string{hbaA, hbaB},
			want:       []string{hbaB},
		},
		{
			...
			session:    &session{hostAddressesByTarget: map[string][]string{targetA: {strings.ToUpper(hbaA)}}},
			targetAddr: targetA,
			hostAddrs:  []string{hbaA, hbaB},
			want:       []string{hbaB},
		},
