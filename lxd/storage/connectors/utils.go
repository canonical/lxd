...
func GetDiskDevicePath(diskNamePrefix string, diskNameSuffix string) (string, error) {
	devPath, err := findDiskDevicePath(diskNamePrefix, diskNameSuffix)
	if err != nil {
		return "", err
	}
...
// is returned.
func WaitDiskDevicePath(ctx context.Context, diskNamePrefix string, diskNameSuffix string) (string, error) {
	var err error
	var devPath string
...
func findDiskDevicePath(diskNamePrefix string, diskNameSuffix string) (string, error) {
...
func WaitDiskDeviceGone(ctx context.Context, diskPath string, timeoutSeconds int) bool {
