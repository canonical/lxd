...
type Pool interface {
	...
	UpdateInstanceBackupFile(inst instance.Instance, snapshots bool, version api.BackupMetadataVersion, op *operations.Operation) error
	...
	BackupInstance(inst instance.Instance, tarWriter *instancewriter.InstanceTarWriter, optimized bool, snapshots bool, version api.BackupMetadataVersion, op *operations.Operation) error
