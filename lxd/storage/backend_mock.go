...
func (b *mockBackend) UpdateInstanceBackupFile(inst instance.Instance, snapshot bool, version api.BackupMetadataVersion, op *operations.Operation) error {
	return nil
}
...
// BackupInstance ...
func (b *mockBackend) BackupInstance(inst instance.Instance, tarWriter *instancewriter.InstanceTarWriter, optimized bool, snapshots bool, version api.BackupMetadataVersion, op *operations.Operation) error {
	return nil
}
