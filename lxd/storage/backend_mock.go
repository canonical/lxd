...
// GetInstanceNBD ...
func (b *mockBackend) GetInstanceNBD(inst instance.Instance, writable bool, reuse bool) (net.Conn, func(), string, error) {
	return nil, nil, "", nil
}

// GetInstanceAllDisksNBD ...
func (b *mockBackend) GetInstanceAllDisksNBD(inst instance.Instance, reuse bool) (net.Conn, func(), string, error) {
	return nil, nil, "", nil
}

// GetCustomVolumeNBD ...
func (b *mockBackend) GetCustomVolumeNBD(projectName string, volName string, writable bool, reuse bool) (net.Conn, func(), string, error) {
	return nil, nil, "", nil
}
