...
// optimized migration.
func (b *lxdBackend) MigrationTypes(contentType drivers.ContentType, refresh bool, snapshots bool) []migration.Type {
	return b.driver.MigrationTypes(contentType, refresh, snapshots)
}
