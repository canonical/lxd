...
func (d *powerflex) EnsureImage(imgVol Volume, filler *VolumeFiller, progressReporter ioprogress.ProgressReporter) error {
...
func (d *powerflex) ActivateTask(vol Volume, task func(devPath string) error) error {
