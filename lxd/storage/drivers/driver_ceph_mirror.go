...
// state extracts the replay state rbd embeds as JSON after the readable part of the description, or
// nil when the description carries none.
...
// seen a mirror snapshot, has not reported a replay state yet and counts as "not yet".
