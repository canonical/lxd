...
// Return true if this an API request coming from a Micro* service that is creating a delegated cluster link.
func isDelegatedClusterLink(r *http.Request) bool {
