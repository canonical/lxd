...
func (c *cmdRecover) command() *cobra.Command {
	...
	Recover LXD database records for instances and custom volumes
  ...
  database records for instances and custom volumes discovered in the storage
  pools. Before doing so, the tool will prompt you to manually re-create other
  missing entities that it discovers.
