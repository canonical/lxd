...
//
//	Selective state field rendering is supported using the syntax:
...
//	  - in: query
//	    name: recursion
//	    description: Recursion level (0, 1) or selective fields ([state.disk,state.network])
//	    type: string
//	    example: 1
//	responses:
//	  "200":
...
func instanceGet(d *Daemon, r *http.Request) response.Response {
	...
	recursionLevel, stateOpts, err := instance.ParseRecursionFields(recursionStr)
	if err != nil {
