...
func TestAllowInstanceCreation_NotConfigured(t *testing.T) {
	...
	err := limits.AllowInstanceCreation(nil, tx, "default", "none", &api.ClusterMemberSysInfo{}, req)
...
func TestAllowInstanceCreation_Below(t *testing.T) {
	...
	err = limits.AllowInstanceCreation(nil, tx, "p1", "none", &api.ClusterMemberSysInfo{}, req)
	assert.NoError(t, err)
}
