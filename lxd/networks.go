...
func addNetworkDetailsToRequestContext(d *Daemon, r *http.Request) error {
...
func networkAccessHandler(entitlement auth.Entitlement) func(d *Daemon, r *http.Request) response.Response {
	return func(d *Daemon, r *http.Request) response.Response {
		err := addNetworkDetailsToRequestContext(d, r)
		if err != nil {
		...
		err = d.State().Authorizer.CheckPermission(r.Context(), entity.NetworkURL(details.requestProject.Name, details.networkName), entitlement)
		if err != nil {
			return response.SmartError(err)
		}
