...
func doNetworkDelete(ctx context.Context, s *state.State, name string, projectName string, requestProjectConfig map[string]string, clusterNotification bool, clientType clusterRequest.ClientType) error {
