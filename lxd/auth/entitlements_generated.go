...
const (
	...
	// EntitlementCanViewEvents is the "can_view_events" entitlement. It applies to the following entities: entity.TypeServer.
	...
	// EntitlementCanViewLifecycleEvents is the "can_view_lifecycle_events" entitlement. It applies to the following entities: entity.TypeProject.
	EntitlementCanViewLifecycleEvents Entitlement = "can_view_lifecycle_events"
...
var EntityTypeToEntitlements = map[entity.Type][]Entitlement{
	...
	entity.TypeProject: {
		...
		// Grants permission to view lifecycle events relating to the project.
		EntitlementCanViewLifecycleEvents,
