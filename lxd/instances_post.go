...
// createFromConversion uploads the image to the server's backup directory, converts it into the
// the raw format, and imports the LXD instance using the converted image.
