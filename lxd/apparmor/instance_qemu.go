...
profile "{{ .name }}" flags=(attach_disconnected,mediate_deleted) {
  ...
  {{ .ovmfPath }}/OVMF_CODE.secboot.fd      kr,
  {{ .ovmfPath }}/OVMF_CODE.ms.fd           kr,
  {{ .ovmfPath }}/OVMF_CODE_4M.fd           kr,
  {{ .ovmfPath }}/OVMF_CODE_4M.secboot.fd   kr,
  {{ .ovmfPath }}/OVMF_CODE_4M.ms.fd        kr,
  /usr/share/qemu/**                        kr,
