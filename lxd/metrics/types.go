...
const (
	...
	ProcsTotal
	// Replicators represents the number of configured replicators.
	Replicators
	// ReplicatorLastRunStatus represents the status of the last replicator run.
	ReplicatorLastRunStatus
	// ReplicatorLastSuccessTimestamp represents the time of the last successful replicator run.
	ReplicatorLastSuccessTimestamp
	// ReplicatorLastSuccessOldestSnapshotTimestamp represents the creation time of the oldest
	// snapshot replicated by the last successful replicator run.
...
var MetricNames = map[MetricType]string{
	...
	Replicators:                    "lxd_replicators",
	ReplicatorLastRunStatus:        "lxd_replicator_last_run_status",
	ReplicatorLastSuccessTimestamp: "lxd_replicator_last_success_timestamp",
	ReplicatorLastSuccessOldestSnapshotTimestamp: "lxd_replicator_last_success_oldest_snapshot_timestamp",
...
var MetricHeaders = map[MetricType]string{
	...
	Replicators:                    "# HELP lxd_replicators The number of configured replicators.",
	ReplicatorLastRunStatus:        "# HELP lxd_replicator_last_run_status Whether the last replicator run ended in the given status.",
	ReplicatorLastSuccessTimestamp: "# HELP lxd_replicator_last_success_timestamp The time of the last successful replicator run in seconds since the epoch.",
	ReplicatorLastSuccessOldestSnapshotTimestamp: "# HELP lxd_replicator_last_success_oldest_snapshot_timestamp The creation time of the oldest snapshot replicated by the last successful replicator run in seconds since the epoch.",
