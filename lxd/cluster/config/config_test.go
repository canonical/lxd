...
// package. It's off by default for real installs; this package's tests need it on to exercise
// the feature's real behavior instead of its default-hidden one.
