...
func ConnectNotification(ctx context.Context, address string, networkCert *shared.CertInfo, serverCert *shared.CertInfo, createOperation bool) (lxd.InstanceServer, error) {
	userAgent := request.UserAgentNotifier
	if !createOperation {
