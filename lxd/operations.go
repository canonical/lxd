...
// operationsGetByType gets all the operations for a project and type.
...
// autoRemoveOrphanedOperationsTask returns a task to clean up orphaned operations on the cluster leader hourly.
