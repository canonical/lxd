...
type MigrateReceiveArgs struct {
	...
	// TransferStarted is called once the target has accepted the source's offer and is about to write the
	// first volume. Nothing on disk has changed before it runs. Optional.
