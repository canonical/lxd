...
// Command returns a Cobra command to send stdin data to a unix socket for websocket forwarding purposes.
...
// Executes the netcat command to forward stdin data to a unix socket and output it over a websocket.
