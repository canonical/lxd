...
// Handles the retrieval of metadata for a given instance.
...
// Handles the patching of metadata for a specific instance.
...
// Handles the updating of metadata for a specific instance using the HTTP PUT method.
...
// Updates the metadata for a specific instance and saves it to "metadata.yaml".
...
// Retrieves and returns instance metadata templates or a specific template file for the given instance.
...
// Creates or updates an instance metadata template for the given instance.
...
// Deletes an instance metadata template for the given instance.
