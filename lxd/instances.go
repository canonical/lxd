...
func instancesShutdown(ctx context.Context, instances []instance.Instance, instancesToOps map[string]*operations.Operation, instancesToOpsMu *sync.Mutex) {
	...
	if instancesToOps != nil {
		go func() {
			// Map to track busy instances and their associated wait group index
