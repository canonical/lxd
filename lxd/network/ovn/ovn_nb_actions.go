...
func (o *NB) LogicalRouterAdd(ctx context.Context, routerName OVNRouter, mayExist bool) error {
...
// If mayExist is true, then an existing resource of the same name is not treated as an error.
func (o *NB) LogicalSwitchAdd(ctx context.Context, switchName OVNSwitch, mayExist bool) error {
...
// If mayExist is true, then an existing resource of the same name is not treated as an error.
func (o *NB) ChassisGroupAdd(ctx context.Context, haChassisGroupName OVNChassisGroup, mayExist bool) error {
	// Define the group.
