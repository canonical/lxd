...
// Checks if STP is enabled by looking up the "stp_enable" boolean config variable.
...
// Returns the STP forward delay in ms. OVS returns the value in seconds, so it needs to be
...
// Retrieve the PVID of bridgeName.
