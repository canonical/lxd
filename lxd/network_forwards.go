...
func networkForwardsPost(d *Daemon, r *http.Request) response.Response {
	...
	listenAddress, err := n.ForwardCreate(req, request.UserAgentClientType(r))
	if err != nil {
...
func networkForwardDelete(d *Daemon, r *http.Request) response.Response {
	...
	err = n.ForwardDelete(listenAddress, request.UserAgentClientType(r))
	if err != nil {
...
func networkForwardPut(d *Daemon, r *http.Request) response.Response {
	...
	err = n.ForwardUpdate(listenAddress, req, request.UserAgentClientType(r))
	if err != nil {
