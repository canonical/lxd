...
func networkForwardsPost(d *Daemon, r *http.Request) response.Response {
	...
	listenAddress, err := n.ForwardCreate(r.Context(), req, requestor.ClientType())
	if err != nil {
...
func networkForwardDelete(d *Daemon, r *http.Request) response.Response {
	...
	err = n.ForwardDelete(r.Context(), listenAddress, requestor.ClientType())
	if err != nil {
...
func networkForwardPut(d *Daemon, r *http.Request) response.Response {
	...
	err = n.ForwardUpdate(r.Context(), listenAddress, req, requestor.ClientType())
	if err != nil {
