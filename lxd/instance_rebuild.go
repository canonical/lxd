...
func instanceRebuildPost(d *Daemon, r *http.Request) response.Response {
	...
	op, err := operations.CreateUserOperation(s, targetProject.Name, requestor, operations.OperationClassTask, operationtype.InstanceRebuild, resources, nil, run, nil, nil)
	if err != nil {
