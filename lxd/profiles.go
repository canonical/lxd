...
func addProfileDetailsToRequestContext(d *Daemon, r *http.Request) error {
	s := d.State()
...
func profileAccessHandler(entitlement auth.Entitlement) func(d *Daemon, r *http.Request) response.Response {
	return func(d *Daemon, r *http.Request) response.Response {
		err := addProfileDetailsToRequestContext(d, r)
		if err != nil {
		...
		err = d.State().Authorizer.CheckPermission(r.Context(), entity.ProfileURL(request.ProjectParam(r), details.profileName), entitlement)
		if err != nil {
			return response.SmartError(err)
		}
