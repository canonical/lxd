...
func (d *Daemon) init() error {
	...
	if oidcIssuer != "" && oidcClientID != "" {
		...
		d.oidcVerifier, err = oidc.NewVerifier(d.shutdownCtx, oidcIssuer, oidcClientID, oidcClientSecret, oidcScopes, oidcAudience, oidcGroupsClaim, d.globalConfig.ClusterUUID(), d.getCoreAuthSecrets, httpClientFunc, sessionHandler)
		if err != nil {
			return err
		}
	}
