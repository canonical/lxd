...
type configMetadata struct {
	// lastModified tracks the files modification file when the backup config gets read from file.
...
type Config struct {
	// Unexported fields.
	// We cannot simply embed them as it will let the JSON marshaller panic.
