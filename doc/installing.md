...
```bash
sudo apt update
sudo apt install acl attr autoconf automake dnsmasq-base git libacl1-dev libcap-dev libsqlite3-dev libtool libudev-dev liblz4-dev libuv1-dev make meson ninja-build pkg-config python3-venv rsync squashfs-tools tar tcl xz-utils ebtables
