...
Only the LVM driver supports the {ref}`storage-block-based` storage feature.
...
{ref}`storage-optimized-volume-refresh`     | No            | **Yes**   | **Yes**[^2] | **Yes**
{ref}`storage-copy-on-write`                | No            | **Yes**   | **Yes**     | **Yes**
{ref}`storage-instant-cloning`              | No            | **Yes**   | **Yes**     | **Yes**
{ref}`storage-driver-usable-in-container`   | **Yes**       | **Yes**   | No          | **Yes**[^3]
...
[^3]: Requires {config:option}`storage-zfs-volume-conf:zfs.delegate` to be enabled.
...
Only the Ceph RBD driver supports these features: {ref}`storage-available-init` and {ref}`storage-optimized-volume-transfer`[^4].
...
{ref}`storage-optimized-volume-refresh`     | **Yes**[^5]  | No              | **Yes**[^6]     | **Yes**[^6]  | **Yes**[^6]
{ref}`storage-instant-cloning`              | **Yes**      | No              | **Yes**         | **Yes**      | No
{ref}`storage-volume-recovery`              | **Yes**      | **Yes**[^7]     | No              | **Yes**[^7]  | No
```
