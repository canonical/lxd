...
- [{spellexception}`Cross-project instance copy bypass via config merge timing (CVE-2026-63297)`](https://github.com/canonical/lxd/security/advisories/GHSA-v989-qw7w-xvg4)
