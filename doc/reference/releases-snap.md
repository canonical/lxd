...
Standard support for LTS releases starts at the full support level, then moves to maintenance support, then extended support. Once it reaches End of Life (EOL), it no longer receives any updates.
...
- **Maintenance support**: High impact bugfixes and security updates are provided, as needed.
- **Extended support**: Only critical security updates are provided, as needed.
