...
### Chassis
A chassis is where traffic physically ingresses to or egresses from the virtual network.
...
If the chassis group prioritizes another chassis for the uplink, the traffic is routed that chassis.
```
