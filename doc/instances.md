...
limits.memory.swap.priority                 | integer   | 10 (maximum)      | yes           | container                 | The higher this is set, the more likely the instance is to be swapped to disk (integer between 0 and 10)
