...
To prepare for a disaster, set up:
...
## Restore and fail back to the primary cluster
...
To synchronize the primary cluster with the secondary cluster, stop all running instances in the source project on the primary cluster.
