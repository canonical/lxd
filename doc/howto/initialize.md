...
MAAS support (see [`canonical.com/maas`](https://canonical.com/maas) and [MAAS - Setting up LXD for VMs](https://canonical.com/maas/docs/how-to-manage-machines#p-9078-use-lxd-vms))
