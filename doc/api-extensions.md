...
* {config:option}`device-nic-ovn-device-conf:acceleration.parent` - Physical function parent interface to allocate virtual functions from for hardware offloading.
