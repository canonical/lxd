...
Introduces a new global configuration key {config:option}`server-miscellaneous:network.ovs.connection` which can be used to override the Open vSwitch connection string.
