...
Adds `GET /1.0/documentation` API endpoint to retrieve the generated YAML file containing the documentation for all the cluster, instance and server options.
