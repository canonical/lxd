...
If you discover a security issue, see the [LXD security policy](https://github.com/canonical/lxd/blob/master/SECURITY.md) for information on how to report the issue.
