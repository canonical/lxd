...
dqlite:
	...
	@if [ ! -e "$(DQLITE_PATH)" ]; then \
		...
		git -C "$(DQLITE_PATH)" checkout 67eb271cd1729686c56b917a5ede12fcae7369ab ; \
...
dist: doc
	...
	git -C "$(TMP)/lxd-$(VERSION)/vendor/dqlite" checkout 67eb271cd1729686c56b917a5ede12fcae7369ab
