...
fine_grained: true"
  ...
  expectedBearerInfo=$(cat<<EOF
authentication_method: bearer
type: LXD token bearer
...
EOF
  ...
  # When bearer token is passed using environemnt variable, it will take precedence over the OIDC/TLS
...
user_is_server_admin() {
  ...
  # The token works.
  # Make sure to the bearer token does not take precedence remote removal.
  (
    unset LXD_AUTH_BEARER_TOKEN
