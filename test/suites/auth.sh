...
fine_grained: true"
  ...
  echo "${list_output}" | grep -Fq 'server,/1.0,"admin:(admin),project_manager:(test-group),viewer:(test-group),can_create_groups,can_create_identities,can_create_identity_provider_groups,..."'
