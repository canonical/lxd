test_image_expiry() {
  ...
  # shellcheck disable=2153
  lxc_remote image registry create l1:img --protocol=lxd url="https://${LXD_ADDR}" source_project=default
...
test_image_refresh() {
  ...
  lxc_remote image registry create img --protocol=lxd url="https://${LXD2_ADDR}" source_project=default
...
test_image_cached() {
  ...
  lxc image registry create l2 --protocol=lxd url="https://${LXD2_ADDR}" source_project=default
