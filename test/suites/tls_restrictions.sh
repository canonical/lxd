test_tls_restrictions() {
  ...
  networkName="net$(tr -dc A-Za-z0-9 </dev/urandom | head -c 3)"
  ...
  zoneName="zone$(tr -dc A-Za-z0-9 </dev/urandom | head -c 3)"
  ...
  profileName="prof$(tr -dc A-Za-z0-9 </dev/urandom | head -c 3)"
  ...
  volName="vol$(tr -dc A-Za-z0-9 </dev/urandom | head -c 3)"
  ...
  bucketName="bucket$(tr -dc a-z0-9 </dev/urandom | head -c 3)"
