test_network_ovn() {
  ...
  echo "Set OVN ranges."
  lxc network set "${uplink_network}" ipv4.ovn.ranges=10.145.237.100-10.145.237.254
  lxc network set "${uplink_network}" ipv6.ovn.ranges=fd42:8cf6:32a0:8087::100-fd42:8cf6:32a0:8087::254

  echo "Set IP routes that include OVN ranges."
  lxc network set "${uplink_network}" ipv4.routes=10.145.237.0/24
  lxc network set "${uplink_network}" ipv6.routes=fd42:8cf6:32a0:8087::/64
  ...
  ! lxc network forward create "${ovn_network}" 10.145.237.100 || false
  ! lxc network forward create "${ovn_network}" fd42:8cf6:32a0:8087::100 || false

  echo "Create a couple of forwards outside of OVN ranges but on the same network."
  lxc network forward create "${ovn_network}" 10.145.237.10
  lxc network forward create "${ovn_network}" fd42:8cf6:32a0:8087::10
  ...
  lxc network forward delete "${ovn_network}" 10.145.237.10
  lxc network forward delete "${ovn_network}" fd42:8cf6:32a0:8087::10
  ...
  ! lxc network load-balancer create "${ovn_network}" 10.145.237.100 || false
  ! lxc network load-balancer create "${ovn_network}" fd42:8cf6:32a0:8087::100 || false

  echo "Create a couple of load balancers outside of OVN ranges but on the same network."
  lxc network load-balancer create "${ovn_network}" 10.145.237.10
  lxc network load-balancer create "${ovn_network}" fd42:8cf6:32a0:8087::10
  ...
  lxc network load-balancer delete "${ovn_network}" 10.145.237.10
  lxc network load-balancer delete "${ovn_network}" fd42:8cf6:32a0:8087::10
