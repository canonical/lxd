test_shutdown() {
    ...
    instance_ops_duration["i1"]=10s
    instance_ops_duration["i2"]=15s
    instance_ops_duration["i3"]=20s
    ...
    expected_msgs=(
        'Starting shutdown sequence'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i1?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i2?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i3?project=default"'
        '"Instance is busy in batch, tracking instance busy state" instance=i1 project=default'
        '"Instance is busy in batch, tracking instance busy state" instance=i2 project=default'
        '"Instance is busy in batch, tracking instance busy state" instance=i3 project=default'
        ...
        '"Instance is not busy in batch" instance=i4 project=default'
        ...
        'All instances have been shutdown, returning'
        'Stopping daemon storage volumes'
        'Daemon storage volumes unmounted'
        'Operations deleted from the database'
        'Closing the database'
    ...
    lxc config set core.shutdown_timeout=2

    declare -A instance_ops_duration
    instance_ops_duration["i1"]=10s
    instance_ops_duration["i3"]=20s
    instance_ops_duration["i4"]=20s
    instance_ops_duration["i5"]=30s
    ...
    expected_msgs=(
        ...
        '"Adding instance to tracker map" entityURL="/1.0/instances/i1?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i3?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i5?project=default"'
        '"Instance is busy in batch, tracking instance busy state" instance=i5 project=default'
        ...
        '"Instance is not busy in batch" instance=i4 project=default'
        '"Instance is not busy in batch" instance=i3 project=default'
        '"Instance is not busy in batch" instance=i2 project=default'
        '"Instance is not busy in batch" instance=i1 project=default'
        '"Instance shutdown complete" instance=i1 project=default'
        '"Instance shutdown complete" instance=i2 project=default'
        '"Instance shutdown complete" instance=i3 project=default'
        '"Instance shutdown complete" instance=i4 project=default'
    ...
    expected_msgs=(
        ...
        '"Adding instance to tracker map" entityURL="/1.0/instances/i3?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i5?project=default"'
        '"Adding volume to tracker map" entityURL="/1.0/storage-pools/backups/volumes/custom/backups_volume?project=default"'
        '"Instance is busy in batch, tracking instance busy state" instance=i5 project=default'
        '"Unmounting daemon storage volumes"'
        '"Successfully unmounted backups storage volume"'
        '"Removing storage backups URL from operations tracker" url="/1.0/storage-pools/backups/volumes/custom/backups_volume?project=default"'
        '"Daemon storage volumes unmounted"'
        '"Stopping instances" stopPriority=3'
        '"Stopping instances" stopPriority=2'
        '"Stopping instances" stopPriority=1'
    ...
    expected_msgs=(
        ...
        '"Adding instance to tracker map" entityURL="/1.0/instances/i3?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i5?project=default"'
        '"Adding volume to tracker map" entityURL="/1.0/storage-pools/images/volumes/custom/images_volume?project=default"'
        '"Instance is busy in batch, tracking instance busy state" instance=i5 project=default'
        '"Unmounting daemon storage volumes"'
        '"Successfully unmounted images storage volume"'
        '"Removing storage images URL from operations tracker" url="/1.0/storage-pools/images/volumes/custom/images_volume?project=default"'
        '"Daemon storage volumes unmounted"'
        '"Stopping instances" stopPriority=3'
        '"Stopping instances" stopPriority=2'
        '"Stopping instances" stopPriority=1'
    ...
    lxd_volume_operation mypool images_volume 10s &
    ...
    expected_msgs=(
        ...
        '"Adding instance to tracker map" entityURL="/1.0/instances/i3?project=default"'
        '"Adding instance to tracker map" entityURL="/1.0/instances/i5?project=default"'
        '"Adding volume to tracker map" entityURL="/1.0/storage-pools/mypool/volumes/custom/images_volume?project=default"'
        '"Adding volume to tracker map" entityURL="/1.0/storage-pools/mypool/volumes/custom/backups_volume?project=default"'
        '"Instance is busy in batch, tracking instance busy state" instance=i5 project=default'
        '"Unmounting daemon storage volumes"'
        '"Successfully unmounted backups storage volume"'
        '"Successfully unmounted images storage volume"'
        '"Removing storage images URL from operations tracker" url="/1.0/storage-pools/mypool/volumes/custom/images_volume?project=default"'
        '"Removing storage backups URL from operations tracker" url="/1.0/storage-pools/mypool/volumes/custom/backups_volume?project=default"'
        '"Daemon storage volumes unmounted"'
        '"Stopping instances" stopPriority=3'
        '"Stopping instances" stopPriority=2'
        '"Stopping instances" stopPriority=1'
    ...
    declare -A instance_ops_duration
    instance_ops_duration["i1"]=200s # This operation will not finish before the shutdown timeout is reached. It will be force stopped.
    instance_ops_duration["i3"]=200s # Same as above.
    instance_ops_duration["i4"]=20s
    instance_ops_duration["i5"]=30s
    ...
    expected_msgs=(
        ...
        '"Instance is busy in batch, tracking instance busy state" instance=i3 project=default'
        '"Unmounting daemon storage volumes"'
        '"Failed to unmount image and backup volumes" err="Failed to unmount backups and images storage volumes due to timeout"'
        '"Unmounting storage volumes timed out"'
        '"Stopping instances" stopPriority=3'
        '"Stopping instances" stopPriority=2'
        '"Instance received for shutdown" instance=i4 project=default'
        '"Instance received for shutdown" instance=i5 project=default'
