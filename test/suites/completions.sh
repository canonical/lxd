...
test_completions() {
    ...
    [ "$(complete config unset '')" = 'c1,c2,core.https_address,localhost:,network.ovs.connection,user.foo' ]
    [ "$(complete config unset c)" = 'c1,c2,core.https_address' ]
    [ "$(complete config unset l)" = 'localhost:' ]
    [ "$(complete config unset localhost: '')" = 'core.https_address,network.ovs.connection,user.foo' ]
