...
test_completions() {
    ...
    [ "$(complete config set c1 '')" = 'boot.,cloud-init.,cluster.,limits.,linux.,migration.,nvidia.,raw.,security.,snapshots.,ubuntu_pro.,user.' ]
    [ "$(complete config set c1 l)" = 'limits.,linux.' ]
    [ "$(complete config set localhost:c1 '')" = 'boot.,cloud-init.,cluster.,limits.,linux.,migration.,nvidia.,raw.,security.,snapshots.,ubuntu_pro.,user.' ]
    [ "$(complete config set c1 limits.)" = 'limits.cpu.,limits.cpu=,limits.disk.,limits.hugepages.,limits.memory.,limits.memory=,limits.processes=' ]
    ...
    [ "$(complete config get c1 '')" = 'boot.,cloud-init.,cluster.,limits.,linux.,migration.,nvidia.,raw.,security.,snapshots.,ubuntu_pro.,user.' ]
    [ "$(complete config get c1 l)" = 'limits.,linux.' ]
    [ "$(complete config get localhost:c1 '')" = 'boot.,cloud-init.,cluster.,limits.,linux.,migration.,nvidia.,raw.,security.,snapshots.,ubuntu_pro.,user.' ]
    [ "$(complete config get c1 limits.)" = 'limits.cpu,limits.cpu.,limits.disk.,limits.hugepages.,limits.memory,limits.memory.,limits.processes' ]
