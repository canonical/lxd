...
test_clustering_project_limits() {
  ...
  ! LXD_DIR="${LXD_ONE_DIR}" lxc init --empty c1 || false
  ...
  ! LXD_DIR="${LXD_ONE_DIR}" lxc init --empty c1 --target node1 || false
  ...
  ! LXD_DIR="${LXD_ONE_DIR}" lxc project set default limits.instances 0 || false
