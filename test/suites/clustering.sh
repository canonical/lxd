...
test_clustering_shutdown_nodes() {
  ...
  # Get container PID
  instance_pid=$(LXD_DIR="${LXD_ONE_DIR}" lxc info foo | grep -i 'PID:' | cut -d' ' -f2)
...
test_clustering_recover() {
  ...
  LXD_DIR="${LXD_ONE_DIR}" lxd cluster list-database | grep -q "100.64.1.101:8443"
  LXD_DIR="${LXD_ONE_DIR}" lxd cluster list-database | grep -q "100.64.1.102:8443"
  LXD_DIR="${LXD_ONE_DIR}" lxd cluster list-database | grep -q "100.64.1.103:8443"
  ...
  LXD_DIR="${LXD_ONE_DIR}" lxd cluster list-database | grep -q "100.64.1.101:8443"
  ! LXD_DIR="${LXD_ONE_DIR}" lxd cluster list-database | grep -q "100.64.1.102:8443" || false
...
test_clustering_remove_raft_node() {
  ...
  LXD_DIR="${LXD_ONE_DIR}" lxd sql local "SELECT * FROM raft_nodes" | grep -q "100.64.1.102"
  ...
  ! LXD_DIR="${LXD_ONE_DIR}" lxd sql local "SELECT * FROM raft_nodes" | grep -q "100.64.1.102" || false
