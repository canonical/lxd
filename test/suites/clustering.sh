...
test_clustering_image_refresh() {
  ...
  LXD_DIR="${LXD_ONE_DIR}" lxc image registry create public --protocol=lxd url="https://100.64.1.104:8443" source_project=default
  ...
  LXD_DIR="${LXD_ONE_DIR}" lxc image registry create cluster --protocol=lxd cluster=lxd_two source_project=default
