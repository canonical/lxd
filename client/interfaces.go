...
type InstanceServer interface {
	...
	GetInstancesFullWithFilterAndRecursion(instanceType api.InstanceType, filters []string, recursion string) (instances []api.InstanceFull, err error)
	GetInstancesFullAllProjectsWithFilterAndRecursion(instanceType api.InstanceType, filters []string, recursion string) (instances []api.InstanceFull, err error)
