...
type InstanceServer interface {
	...
	CreateIdentityTLS(tlsIdentitiesPost api.IdentitiesPostTLS) error
	CreateIdentityTLSPending(tlsIdentitiesPost api.IdentitiesPostTLS) (*api.IdentityTokenTLS, error)
