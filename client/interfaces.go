...
type InstanceServer interface {
	...
	CreateNetwork(network api.NetworksPost) (op Operation, err error)
	UpdateNetwork(name string, network api.NetworkPut, ETag string) (op Operation, err error)
	RenameNetwork(name string, network api.NetworkPost) (op Operation, err error)
	DeleteNetwork(name string) (op Operation, err error)
	...
	UpdateNetworkForward(networkName string, listenAddress string, forward api.NetworkForwardPut, ETag string) (op Operation, err error)
	DeleteNetworkForward(networkName string, listenAddress string) (op Operation, err error)
	...
	CreateNetworkLoadBalancerPool(networkName string, pool api.NetworkLoadBalancerPoolsPost) (err error)
	...
	UpdateNetworkLoadBalancerPool(networkName string, poolName string, pool api.NetworkLoadBalancerPoolPut, ETag string) (op Operation, err error)
	DeleteNetworkLoadBalancer(networkName string, listenAddress string) (op Operation, err error)
	DeleteNetworkLoadBalancerPool(networkName string, poolName string) (err error)
	...
	CreateNetworkACL(acl api.NetworkACLsPost) (op Operation, err error)
	UpdateNetworkACL(name string, acl api.NetworkACLPut, ETag string) (op Operation, err error)
	RenameNetworkACL(name string, acl api.NetworkACLPost) (op Operation, err error)
	DeleteNetworkACL(name string) (op Operation, err error)
	...
	UpdateStoragePoolBucket(poolName string, bucketName string, bucket api.StorageBucketPut, ETag string) (op Operation, err error)
	DeleteStoragePoolBucket(poolName string, bucketName string) (op Operation, err error)
	...
	CreateStoragePoolBucketKey(poolName string, bucketName string, key api.StorageBucketKeysPost) (op Operation, err error)
	UpdateStoragePoolBucketKey(poolName string, bucketName string, keyName string, key api.StorageBucketKeyPut, ETag string) (op Operation, err error)
	DeleteStoragePoolBucketKey(poolName string, bucketName string, keyName string) (op Operation, err error)
