...
func (r *ProtocolLXD) CreateNetworkLoadBalancerPool(networkName string, pool api.NetworkLoadBalancerPoolsPost) (Operation, error) {
	...
	op, _, err := r.queryOperation(http.MethodPost, u.String(), pool, "", true)
	if err != nil {
		return nil, err
	}
