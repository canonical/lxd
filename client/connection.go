...
// ConnectDevLXDHTTP lets you connect to devLXD over a VM socket.
func ConnectDevLXDHTTP(args *ConnectionArgs, client *http.Client) (DevLXDServer, error) {
	return ConnectDevLXDHTTPWithContext(context.Background(), args, client)
}
