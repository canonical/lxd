...
type InstanceStateDisk struct {
	// Disk usage in bytes. We use -1 to indicate the storage driver for the instance's pool does not support getting the disk usage.
	// Example: 502239232
	Usage int64 `json:"usage" yaml:"usage"`

	// Total size in bytes. We use -1 to convey that the instance has access to the entire pool's storage.
	// Example: 502239232
	//
