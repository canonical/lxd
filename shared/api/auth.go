...
const (
	...
	// IdentityTypeBearerTokenLXD represents an identity that bears a LXD token that can be used to interact with the LXD API.
	IdentityTypeBearerTokenLXD = "LXD token bearer"
)
